...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
   <div class="card-body">
    <form action="{{url('/store-pengeluaran')}}" method="POST">
        @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="jenis_pengeluaran" placeholder="Jenis Pengeluaran">
            </div>
            <div class="form-group">
              <label for="detail_pengeluaran">Detail Pengeluaran </label>
              <input class="form-control" type="text" name="detail_pengeluaran" placeholder="Detail Pengeluaran">
            </div>
            <div class="form-group">
              <label for="jumlah_pengeluaran">Jumlah Pengeluaran</label>
              <input class="form-control" type="text" name="jumlah_pengeluaran" placeholder="Jumlah Pengeluaran">
            </div>

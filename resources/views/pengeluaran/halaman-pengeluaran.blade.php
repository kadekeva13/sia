        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="{{route('create-pengeluaran')}}" class="btn btn-primary">Tambah Data <i class="fa fa-plus-square" aria-hidden="true"></i></a>
            </ol>
          </div>
          <!-- /.col -->
        </div>
     ...
     <table class="table table-bordered">
      <tr class="bg-gradient-purple text-center text-bold">
        ...
        @foreach ($dtPengeluaran as $item)
          ...
          <td>
              <a href="{{url("pengeluaran/delete/$item->id")}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
          </td>
          </tr>
      @endforeach 
     </table>

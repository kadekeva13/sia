...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
   <div class="card-body">
    <form action="{{url('/store-pemasukan')}}" method="POST">
        @csrf
            <div class="form-group">
                <label for="tgl_pemasukan">Tanggal </label>
                <input class="form-control" type="date" name="tgl_pemasukan">
            </div>
            {{-- <div class="form-group">
            ...
            <div class="form-group">
                <label for="jenis_pemasukan">Jenis Pemasukan </label>
                <input class="form-control" type="text" name="jenis_pemasukan" placeholder="Jenis Pemasukan">
            </div>
            <div class="form-group">
              <label for="detail_pemasukan">Detail Pemasukan </label>
              <input class="form-control" type="text" name="detail_pemasukan" placeholder="Detail Pemasukan">
            </div>
            <div class="form-group">
              <label for="jumlah_pemasukan">Jumlah Pemasukan</label>
              <input class="form-control" type="text" name="jumlah_pemasukan" placeholder="Jumlah Pemasukan">
            </div>

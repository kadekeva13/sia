...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
   <div class="card-body">
    <form action="{{ url("/customer/$dtCustomer->id") }}" method="POST">
        @method('PATCH')
        @csrf
            <div class="form-group">
                <label for="nama">Nama : </label>
                <input class="form-control" type="text" name="nama" placeholder="Nama Anda" value="{{$dtCustomer->nama}}">
            </div>
            <div class="form-group">
              <label for="email">Email </label>
              <input class="form-control" type="email" name="email" placeholder="Email Anda" value="{{$dtCustomer->email}}">
            </div>
            <div class="form-group">
              <label for="notelp">No Telpon </label>
              <input class="form-control" type="text" name="notelp" placeholder="No.telpon" value="{{$dtCustomer->notelp}}">
            </div>
            .<div class="form-group">
              <label for="alamat">Alamat</label>
              <input class="form-control" type="text" name="alamat" placeholder="Alamat" value="{{$dtCustomer->alamat}}">
            </div>
            <div class="form-group">

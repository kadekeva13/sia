...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
   <div class="card-body">
    <form action="{{ url("/inventory/$dtInventory->id") }}" method="POST">
        @method('PATCH')
        @csrf
        <div>
          <label for="id_customer">Id Pembelian </label>
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="jenis_inventory" placeholder="nama" value="{{$dtInventory->jenis_inventory}}">
      </div>
      <div class="form-group">
        <label for="detail">Detail </label>
        <input class="form-control" type="text" name="detail" placeholder="nama" value="{{$dtInventory->detail}}">
      </div>
